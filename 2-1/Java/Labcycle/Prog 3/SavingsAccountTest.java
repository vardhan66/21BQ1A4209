class SavingsAccTest {
    public static void main(String args[])// Execution bgins here
    {
        ...
        System.out.println("Current  Balence of user1  is 2000");
        System.out.println("Current  Balence of user2  is 3000");
        ...
        System.out.println("New Balence of user1 for interst 4 % is" + (float) saver1.cal_Monthlyintrest());
        System.out.println("New Balence  of user2 for interst 4 % is" + (float) saver2.cal_Monthlyintrest());
        ...
        System.out.println("New Balence of user1 for interst 5 % is" + (float) saver1.cal_Monthlyintrest());
        System.out.println("New Balence  of user2 for interst 5 % is" + (float) saver2.cal_Monthlyintrest());
    }
}